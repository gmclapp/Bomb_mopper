...
S_BOMB = pygame.image.load("art/Bomb.png")

S_LARGE_BUTTON = pygame.image.load("art/Large button.png")
S_LARGE_BUTTON_PRESSED = pygame.image.load("art/Large button pressed.png")
S_NEW_BUTTON_LABEL = pygame.image.load("art/New Game.png")
